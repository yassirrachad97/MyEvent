...
<body>
    ...
    <main>
        <!--? Hero Start -->
        <div class="slider-area2" style="background-image: url('{{ asset('css/mystyle/img/blog/single_blog_1.png') }}')">
                        ...
                        <div class="blog_left_sidebar">
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{ asset('css/mystyle/img/blog/single_blog_1.png') }}" alt="">
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{ asset('css/mystyle/img/blog/single_blog_2.png') }}" alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                                    </a>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{ asset('css/mystyle/img/blog/single_blog_3.png') }}" alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                                    </a>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{ asset('css/mystyle/img/blog/single_blog_4.png') }}" alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                                    </a>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{ asset('css/mystyle/img/blog/single_blog_5.png') }}" alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                                    </a>
                        ...
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('css/mystyle/img/post/post_1.png') }}" alt="post">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('css/mystyle/img/post/post_2.png') }}" alt="post">
                                    <div class="media-body">
                                        <a href="blog_details.html">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('css/mystyle/img/post/post_3.png') }}" alt="post">
                                    <div class="media-body">
                                        <a href="blog_details.html">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('css/mystyle/img/post/post_4.png') }}" alt="post">
                                    <div class="media-body">
                                        <a href="blog_details.html">
                            ...
                            <aside class="single_sidebar_widget instagram_feeds">
                                ...
                                <ul class="instagram_row flex-wrap">
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('css/mystyle/img/post/post_5.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('css/mystyle/img/post/post_6.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('css/mystyle/img/post/post_7.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('css/mystyle/img/post/post_8.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('css/mystyle/img/post/post_9.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('css/mystyle/img/post/post_10.png') }}" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </aside>
            ...
            <div class="container">
                                 ...
                                 <div id="mc_embed_signup">
                                     ...
                                     method="get" class="subscribe_form relative mail_part">
                                         ...
                                         <div class="form-icon">
                                             ...
                                             class="email_icon newsletter-submit button-contactForm"><img src="{{ asset('css/mystyle/img/gallery/form.png') }}" alt=""></button>
                                         </div>
               ...
               <div class="row footer-wejed justify-content-between">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        ...
                        <a href="index.html"><img src="{{ asset('css/mystyle/img/logo/logo2_footer.png') }}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
